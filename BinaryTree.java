...
// I have completed nodes,height,isBalanced and levelOrder method in this class
// I have used binary trees,Array List and basic java OOPs concept to complete that methods
...
public class BinaryTree<T> {
	...
	public static <T> boolean heightBalanced(BinaryTree<T> t) {
		...
		if((heightRight == heightLeft) || heightRight == heightLeft+1 || heightLeft == heightRight+1){
			return true;
		}
		return false;
	}
